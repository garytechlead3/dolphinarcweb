...
const NewsletterContainer = styled(motion.div)`
    ...
    background: linear-gradient(144.92deg, rgba(255, 255, 255, 0.74) 4.15%, #C498E5 95%);
            ...
            <IntroContainer>
                ...
                >
                    <h2 className="gradient-text">
                        A Brand New definition of House, Human interaction, and
                        exploration in the Metaverse
                    </h2>
                    <h3>
                        Subscribe for a chance to join our Whitelist:
                    </h3>
